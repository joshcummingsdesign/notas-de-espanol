...
**Cognates** are words that look and sound similar in two languages because they share a common origin. Words ending in **-al** are often identical or nearly identical in English and Spanish, making them easy to learn and remember.
...
- **personal** - personal
- **principal** - principal
- **professional** - profesional (note: one 's' in Spanish)
- **universal** - universal
- **cultural** - cultural
- **federal** - federal
...
A few **-al** words have different meanings:

- **actual** (Spanish) means "current" or "present," not "actual"
- **eventual** (Spanish) means "possible," not "eventual"

## Example Sentences

- **El hospital está cerca** - The hospital is nearby
- **Es un problema social** - It's a social problem
